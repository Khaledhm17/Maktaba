...
class SupabaseBookRepositoryImpl @Inject constructor(
        ...
        withContext(Dispatchers.IO) {
            ...
            if (imageBytes != null) {
                try {
                    ...
                    Log.d("SupabaseBookRepo", "Attempting to upload bytes: $fileName")
            ...
            insertBookToDb(book.copy(imageUrl = finalImageUrl))
        }
    }
            ...
            if (imageUri != null) {
                try {
                    ...
                    if (bytes != null) {
                        ...
                        Log.d("SupabaseBookRepo", "Attempting to upload uri: $fileName")
    ...
    private suspend fun insertBookToDb(book: Book) {
        try {
